# res://addons/quest_weaver/ui/editor/qw_action_handler.gd
@tool
...
const AddConditionCommand = preload("commands/add_condition_command.gd") # <-- ADDED
const RemoveConditionCommand = preload("commands/remove_condition_command.gd") # <-- ADDED
...
func initialize(p_editor: QuestWeaverEditor, p_history: QWEditorHistory, p_data_manager: QWGraphData, p_properties_panel: Window, p_graph_controller: QuestWeaverGraphController, p_clipboard: QWClipboard) -> void:
